...
import { ChevronDownIcon, FunnelIcon, Bars3Icon } from '@heroicons/vue/20/solid'
      ...
      <div class="col-start-1 row-start-1 py-4">
        <div class="mx-auto flex max-w-7xl justify-end px-4 sm:px-6 lg:px-8">
          <Menu as="div" class="relative inline-block">
            ...
            <button class="relative pl-2 cursor-pointer" type="button" @click="console.log(`Show Horizontal view`)">
                <Bars3Icon class="-mr-1 ml-1 size-5 shrink-0 text-gray-400 group-hover:text-gray-500 cursor-pointer" aria-hidden="true" />
            </button>
